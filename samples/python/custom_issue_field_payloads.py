...
FILTERS = [{"description": "Get all issues about orders with gift wrapped.",
           ...
           {"description": "Get all issues with address containing cities from UK but not London or Liverpool.",
            "query": {"multiline": {"and": {"billing_address": {"is_set": "true",
                                                                "contains": ["UK"],
                                                                "does_not_contain": ["London", "Liverpool"]}}}}},
           ...
           {"description": "Get all issues with item set to standard outdoor games.",
            "query": {"dropdown": {"and": {"item": {"is_set": "true",
                                                    "is_not": "Table Tennis",
                                                    "is_none_of": ["Chess", "Carrom"]}},
                                   "or": {"item": {"is": "Basketball",
                                                   "is_one_of": ["Football", "Cricket"]}}}}},
